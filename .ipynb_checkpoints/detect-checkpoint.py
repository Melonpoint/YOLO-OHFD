...
Usage:
    $ python path/to/detect.py --weights yolo-base.pt --source 0  # webcam
                                                             img.jpg  # image
                                                             vid.mp4  # video
                                                             path/  # directory
                                                             path/*.jpg  # glob
...
@torch.no_grad()
def run(weights=ROOT / 'yolo-base.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='dataset/test/', help='file/dir/URL/glob, 0 for webcam')
